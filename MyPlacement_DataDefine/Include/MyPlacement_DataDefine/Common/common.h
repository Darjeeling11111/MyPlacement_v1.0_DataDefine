...
struct POS_2D // POS means postition which can be used to store coordinates, offsets
{
    ...
    POS_2D(const POS_2D &pos) = default;
    POS_2D(POS_2D &&pos) = default;
    POS_2D &operator=(const POS_2D &pos) = default;
    POS_2D &operator=(POS_2D &&pos) = default;
...
struct VECTOR_3D
{
    ...
    VECTOR_3D(VECTOR_3D &&vec) = default;
    VECTOR_3D &operator=(const VECTOR_3D &vec) = default;
    VECTOR_3D &operator=(VECTOR_3D &&vec) = default;
